...
image: "/_static/blogs/image/pexels-bri-schneiter-28802-346529.jpg"
type: Blog
...
/>
<div className="text-center text-sm text-muted-foreground">Image: Supabase Hybrid Search Architecture</div>
...
<div className="italic font-bold mt-4">
